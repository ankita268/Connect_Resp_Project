...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    //sass related settings - start
    pkg: grunt.file.readJSON('package.json'),
    project: {
        app: ['app'],
        assets: ['<%= project.app %>/styles'],
        css: ['<%= project.assets %>/sass/app.scss']
    },

    projectb: {
        app: ['app'],
        assets: ['<%= projectb.app %>/styles'],
        css: ['<%= projectb.assets %>/sass/bootstrap/bgx-bootstrap.scss']
    },
  ...
  //sass related settings -sTART
    ...
    connect: {
	  ...
	  proxies: [{
		context: '/core', // the context of the data service
		host: 'localhost', // wherever the data service is running
		port: 8081 // the port that the data service is running on
	  }/*,
	  {
		context: '/data', // the context of the data service
		host: 'localhost', // wherever the data service is running
		port: 8484 // the port that the data service is running on		  
	  }*/],
      livereload: {
        options: {
          open: true,
